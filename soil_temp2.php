        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                <div class="breadcrumbs-area">
                    <h3>Soil Temperature at 1200Z</h3>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                ...
                                <form class="new-added-form" method="POST" action="inc/soilbackend2.php">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="number" placeholder="" name="s_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 5cm Temperature</label>
                                            <input type="number" placeholder="" name="5_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 10cm Temperature</label>
                                            <input type="number" placeholder="" name="10_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 20cm Temperature</label>
                                            <input type="number" placeholder="" name="20_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 30cm Temperature</label>
                                            <input type="number" placeholder="" name="30_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 50cm Temperature</label>
                                            <input type="number" placeholder="" name="50_temp" class="form-control" step="any">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter 100cm Temperature</label>
                                            <input type="number" placeholder="" name="100_temp" class="form-control" step="any">
                                        </div>
