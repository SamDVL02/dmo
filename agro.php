           ...
           <?php include  'inc/sidebar.php'?>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Agrometeorological Daily Weather Report (AGRO-MET) at <?php echo $_SESSION['station'] ?> Station</h3>
                    <!-- <ul>
                        <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST"  action="inc/agrobackend.php">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select class="select2" name="station" required>
                                ...
                                <option value="Zanzibar"> Zanzibar</option>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Year</label>
                                            <select class="select2" name="year" id="yearSelect" required>
                                                <option value="">Please Select*</option>
                                            </select>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Observation Name</label>
                                            <input type="text" placeholder="" name="on" class="form-control" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Date</label>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="number" placeholder="" name="MT" class="form-control" step="any"  required>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="number" placeholder="" name="r"  class="form-control" step="any" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Soil Temperature (°C):</label>
                                            <input type="number" placeholder="" name="st"  class="form-control" step="any" required>
                                        </div>
