                    ...
                    <div class="table-responsive">
                        <table class="table display data-table text-nowrap">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM agro WHERE station = :station"; 
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rows['observe_name']; ?></td>
                                    <td><?php echo $rows['max_temp']; ?></td>
                                    <td><?php echo $rows['min_temp']; ?></td>
                                    <td><?php echo $rows['rainfall']; ?></td>
                                    <td><?php echo $rows['soil_temp']; ?></td>
