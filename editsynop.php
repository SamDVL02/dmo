...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE synop SET 
        time_of_observation = :time_of_observation, 
        wind_measuring_instruments = :wind_measuring_instruments, 
        indicator_for_precipitation_data = :indicator_for_precipitation_data, 
        station_operation_weather = :station_operation_weather, 
        height_of_lowest_cloud_base = :height_of_lowest_cloud_base, 
        ...
        low_level_cloud_type = :low_level_cloud_type, 
        medium_level_cloud_type = :medium_level_cloud_type, 
        high_level_cloud_type = :high_level_cloud_type, 
        grass_temperature = :grass_temperature, 
        character_intensity_of_precipitation = :character_intensity_of_precipitation, 
        hours_from_precipitation_to_observation = :hours_from_precipitation_to_observation, 
        precipitation_amount = :precipitation_amount, 
        type_of_instrument_for_evaporation_measurement = :type_of_instrument_for_evaporation_measurement, 
        sunshine_card_segments = :sunshine_card_segments,  
        wet_bulb_temperature = :wet_bulb_temperature, 
        cups_added_removed = :cups_added_removed, 
        first_lowest_cloud_layer_type = :first_lowest_cloud_layer_type, 
        first_lowest_cloud_layer_base_height = :first_lowest_cloud_layer_base_height, 
        second_lowest_cloud_layer_type = :second_lowest_cloud_layer_type, 
        second_lowest_cloud_layer_base_height = :second_lowest_cloud_layer_base_height, 
        third_lowest_cloud_layer_type = :third_lowest_cloud_layer_type,
        third_lowest_cloud_layer_base_height = :third_lowest_cloud_layer_base_height,
        fourth_lowest_cloud_layer_type = :fourth_lowest_cloud_layer_type,
        fourth_lowest_cloud_layer_base_height = :fourth_lowest_cloud_layer_base_height
        WHERE id = :id";

    // Prepare the statement
    $stmt = $conn->prepare($sql);

    // Create an array of POST fields to bind
    $postFields = [
        't_o_o' => 'time_of_observation',
        'w_m_i_u' => 'wind_measuring_instruments',
        'i_f_i_o_p' => 'indicator_for_precipitation_data',
        'type' => 'station_operation_weather',
        'height_above_s_b_l_c_s' => 'height_of_lowest_cloud_base',
        'visibility' => 'visibility',
        'p_d' => 'precipitation_duration',
        'p_w' => 'present_weather',
        'pa_w1' => 'past_weather_1',
        'pa_w2' => 'past_weather_2',
        'l_l_c_t' => 'low_level_cloud_type',
        'm_l_c_t' => 'medium_level_cloud_type',
        'h_l_c_t' => 'high_level_cloud_type',
        'mi_t' => 'grass_temperature',
        'c_i_p' => 'character_intensity_of_precipitation',
        'n_h_b_e' => 'hours_from_precipitation_to_observation',
        'p_a_f_3' => 'precipitation_amount',
        't_i_e_m' => 'type_of_instrument_for_evaporation_measurement',
        'c_s_s_c' => 'sunshine_card_segments',
        'n_c_e' => 'cups_added_removed',
        'i_l_c_l_t_1' => 'first_lowest_cloud_layer_type',
        'i_l_c_l_b_h_1' => 'first_lowest_cloud_layer_base_height',
        'i_l_c_l_t_2' => 'second_lowest_cloud_layer_type',
        'i_l_c_l_b_h_2' => 'second_lowest_cloud_layer_base_height',
        'i_l_c_l_t_3' => 'third_lowest_cloud_layer_type',
        'i_l_c_l_b_h_3' => 'third_lowest_cloud_layer_base_height',
        'i_l_c_l_t_4' => 'fourth_lowest_cloud_layer_type',
        'i_l_c_l_b_h_4' => 'fourth_lowest_cloud_layer_base_height',
    ];

    // Bind parameters dynamically
    foreach ($postFields as $postKey => $dbField) {
        $value = getPostValue($postKey);
        $stmt->bindParam(":$dbField", $value);
    }
    ...
    try {
        ...
        if ($result) {
            $_SESSION["SuccessMessage"] = "Synop Data updated successfully";
            header("Location: view_synop_data.php");
            exit();
        } else {
            $_SESSION["ErrorMessage"] = "Something went wrong. Try again!";
            header("Location: editsynop.php?id=$id");
            exit();
        }
...
// Function to get post value safely
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Edit Synop Data</h3>
                  
                </div>
                <!-- Breadcubs Area End Here -->
                <!-- Account Settings Area Start Here -->
                <?php
$sql  = "SELECT * FROM synop WHERE id='$id'";
$stmt = $conn ->query($sql);
while ($rows=$stmt->fetch()) {
$id    = $rows['id'];
$t_o = $rows['time_of_observation'];
$w_m_i = $rows['wind_measuring_instruments'];
$ifpd = $rows['indicator_for_precipitation_data'];
$sow   = $rows['station_operation_weather'];
$hflcb = $rows["height_of_lowest_cloud_base"];
$visibility   = $rows['visibility'];
$precipitation_duration = $rows["precipitation_duration"];
$present_weather   = $rows['present_weather'];
$pw1  = $rows['past_weather_1'];
$pw2  = $rows['past_weather_2'];
$low_level_cloud_type  = $rows['low_level_cloud_type'];
$mlct = $rows['medium_level_cloud_type'];
$hlct  = $rows['high_level_cloud_type'];
$gt = $rows['grass_temperature'];
$ciop  = $rows['character_intensity_of_precipitation'];
$hfpo  = $rows['hours_from_precipitation_to_observation'];
$pa  = $rows['precipitation_amount'];
$toiem  = $rows['type_of_instrument_for_evaporation_measurement'];
$scs  = $rows['sunshine_card_segments'];
$car  = $rows['cups_added_removed'];
$flclt  = $rows['first_lowest_cloud_layer_type'];
$flclbh  = $rows['first_lowest_cloud_layer_base_height'];
$slclt  = $rows['second_lowest_cloud_layer_type'];
$slclbh  = $rows['second_lowest_cloud_layer_base_height'];
$tlclt  = $rows['third_lowest_cloud_layer_type'];
$tlclbh  = $rows['third_lowest_cloud_layer_base_height'];
$folclt  = $rows['fourth_lowest_cloud_layer_type'];
$folclbh  = $rows['fourth_lowest_cloud_layer_base_height'];
}
...
?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="editsynop.php?id=<?php echo $id; ?>">
                             <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="time-of-observation" name="t_o_o" value="<?php echo $t_o ?>" required>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="w_m_i_u" name="w_m_i_u" value="<?php echo $w_m_i  ?>" >
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_f_i_o_p" name="i_f_i_o_p" value="<?php echo $ifpd  ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="type" name="type" value="<?php echo $sow   ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="height_above_s_b_l_c_s" name="height_above_s_b_l_c_s" value="<?php echo $hflcb ?>" >
                                                <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="visibility" name="visibility" value="<?php echo $visibility  ?>" >
                                               <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="p_d" name="p_d" value="<?php echo $precipitation_duration ?>" >
        <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="p_w" name="p_w" value="<?php echo $present_weather ?>" >
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="pa_w1" name="pa_w1" value="<?php echo $pw1 ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="pa_w2" name="pa_w2" value="<?php echo $pw2 ?>" >
            <option value="" disabled selected></option>
                                                <option value="0">Cloud covering (0.5) or less of the sky throughout appropriate period (0)</option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="l_l_c_t" name="l_l_c_t" value="<?php echo $low_level_cloud_type ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="m_l_c_t" name="m_l_c_t" value="<?php echo $mlct ?>" >
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="h_l_c_t" name="h_l_c_t" value="<?php echo $hlct ?>" >
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <input type="number" id="mi_t" name="mi_t" class="form-control" value="<?php echo $gt ?>"  step="any">
        </div>

        <div class="col-xl-3 col-lg-6 col-12 form-group">
            <label for="c_i_p">Character and Intensity of Precipitation (Rc)</label>
            <select class="select2" id="c_i_p" name="c_i_p" value="<?php echo $ciop ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="n_h_b_e" name="n_h_b_e" value="<?php echo $hfpo ?>" >
            <option value="" disabled selected></option>
    ...
    <!-- Precipitation Measurements -->
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <input type="number" id="p_a_f_3" name="p_a_f_3" class="form-control"  value="<?php echo $pa  ?>"  step="any">
        </div>


        <div class="col-xl-3 col-lg-6 col-12 form-group">
            <label for="t_i_e_m">Type of Instrument for Evaporation Measurement</label>
            <select class="select2" id="t_i_e_m" name="t_i_e_m" value="<?php echo $toiem ?>" >
            <option value="" disabled selected></option>
      ...
      <h3 class="col-12"><b>Sunshine Information</b></h3>
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <input type="number" id="c_s_s_c" name="c_s_s_c" class="form-control" value="<?php echo $scs ?>"  step="any">
        </div>
       
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            <label for="n_c_e">Cups Added/Removed (Evaporation)</label>
            <input type="number" id="n_c_e" name="n_c_e" class="form-control" value="<?php echo $car  ?>"  step="any">
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_t_1" name="i_l_c_l_t_1" value="<?php echo $t_o ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_b_h_1" name="i_l_c_l_b_h_1" value="<?php echo $flclt ?>" >
            <option value="" disabled selected></option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_t_2" name="i_l_c_l_t_2" value="<?php echo $flclbh ?>" >
            <option value="" disabled selected></option>
                                                <option value="0">Cirrus-Ci (0)</option>                                               
                                                <option value="1">Cirrocumulus-Cc (1)</option>                                                
                                                <option value="2">Cirrostratus-Cs (2)</option>                                              
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_b_h_2" name="i_l_c_l_b_h_2" value="<?php echo $slclbh ?>" >
            <option value="" disabled selected></option>
            <option value="00">Less than 30m or 100ft (00)</option>
                                                <option value="01">30m or 100ft (01)</option>
                                                <option value="02">60m or 200ft (02)</option>
          ...
          <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_t_3" name="i_l_c_l_t_3" value="<?php echo $tlclt  ?>" >
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_b_h_3" name="i_l_c_l_b_h_3" value="<?php echo  $tlclbh  ?>" >
            <option value="" disabled selected></option>
            <option value="01">30m or 100ft (01)</option>
                                                <option value="02">60m or 200ft (02)</option>
                                                <option value="03">90m or 300ft (03)</option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_t_4" name="i_l_c_l_t_4" value="<?php echo $folclt ?>" >
            <option value="" disabled selected></option>
                                                <option value="0">Cirrus-Ci (0)</option>
                                                <option value="1">Cirrocumulus-Cc (1)</option>
                                                <option value="2">Cirrostratus-Cs (2)</option>                                            
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group">
            ...
            <select class="select2" id="i_l_c_l_b_h_4" name="i_l_c_l_b_h_4" value="<?php echo $folclbh ?>" >
            <option value="" disabled selected></option>
            <option value="01">30m or 100ft (01)</option>
                    <option value="02">60m or 200ft (02)</option>
                    <option value="03">90m or 300ft (03)</option>
