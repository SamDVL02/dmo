                                ...
                                <form class="new-added-form" method="POST"  action="inc/agrobackend1.php">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="number" placeholder="" name="pheno_phase" class="form-control" step="any" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter Length</label>
                                            <input type="number" placeholder="" name="length" class="form-control" step="any" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter width</label>
                                            <input type="number" placeholder="" name="width" class="form-control" step="any"  required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Enter Height</label>
                                            <input type="number" placeholder="" name="height" class="form-control" step="any" required>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="text" placeholder="" name="P_in"  class="form-control" required>
                                        </div>                               
