                                ...
                                <form class="new-added-form" method="POST" action="inc/autogen_taf_bac.php">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select id="taf_type" class="select2" name="taf_type">
                                                <option value=""></option>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select id="taf_time" class="select2" name="taf_time">
                                                <option></option>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select id="taf_services" class="select2" name="taf_services">
                                                <option value=""></option>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select id="subject" class="select2" name="subject">
                                                <option value=""></option>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select id="cavok" class="select2" name="cavok">
